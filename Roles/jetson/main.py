...
class Network(object):
    ...
    def push_to_db(self):
    	try: 
			...
			csv_inventory_output.writerow(["score", "shelf", "duplicate", "camera", "x", "y", "type"])
			for json_inventory_output in json_inventory_output:
    			inventory.writerow([json_inventory_output["score"],
                			json_inventory_output["shelf"],
			                json_inventory_output["duplicate"],
			                json_inventory_output["camera"],
			                json_inventory_output["x"], 
			                json_inventory_output["y"],
			                json_inventory_output["type"]])
